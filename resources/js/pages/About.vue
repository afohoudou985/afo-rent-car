            ...
            <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div class="mb-20">
                    <div class="grid items-center gap-12 lg:grid-cols-2">
                        <div>
                            ...
                            >
                                <p>
                                    Fondée en 2015, Afo Rent Car est née d’une
                                    mission simple : offrir des services de
                                    location de voitures fiables, abordables et
                                    pratiques aux voyageurs comme aux habitants.
                                    Ce qui a commencé avec une petite flotte de
                                    10 véhicules s’est développé pour devenir un
                                    service complet de location avec plus de 200
                                    véhicules premium.
                                </p>
                                <p>
                                    Nous savons que chaque trajet est important,
                                    qu’il s’agisse d’un voyage d’affaires, de
                                    vacances en famille ou d’un déplacement
                                    quotidien. C’est pourquoi nous avons
                                    construit notre réputation sur la confiance,
                                    la qualité et un service client
                                    exceptionnel.
                                </p>
                            </div>
                        </div>
                ...
                <div class="mb-20">
                    <div class="mb-12 text-center">
                        ...
                        <p class="mx-auto max-w-2xl text-gray-600">
                            Nous nous engageons à offrir des expériences
                            exceptionnelles de location de voitures tout en
                            maintenant les plus hauts standards de service et
                            d’intégrité.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="p-6 text-center">
                            ...
                            <p class="text-gray-600">
                                ...
                                d’esprit lors de chaque trajet.
                            </p>
                        </div>
                        ...
                        <div class="p-6 text-center">
                            ...
                            <p class="text-gray-600">
                                Aucun frais caché, aucune surprise. Nous croyons
                                en une tarification claire et transparente ainsi
                                qu’en une communication honnête avec tous nos
                                clients.
                            </p>
                        </div>
                        ...
                        <div class="p-6 text-center">
                            ...
                            <p class="text-gray-600">
                                ...
                                attentes grâce à un service supérieur, des
                                véhicules de qualité et des solutions
                                innovantes.
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Des véhicules modernes et bien
                                            entretenus provenant des meilleurs
                                            constructeurs.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            ...
                                            routière disponibles à tout moment.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Réservation en ligne simple avec des
                                            options flexibles de prise en charge
                                            et de retour.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Les meilleurs prix du marché sans
                                            frais cachés.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Points de retrait pratiques dans
                                            toute la ville.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Tous les véhicules passent des
                                            inspections de sécurité rigoureuses.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="mb-20">
                    <div class="mb-12 text-center">
                        ...
                        <p class="mx-auto max-w-2xl text-gray-600">
                            ...
                            avancer notre entreprise et garantissent un service
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600">
                                ...
                                automobile avec une passion pour l'excellence du
                                service client.
                            </p>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600">
                                Expert en gestion de flotte et logistique avec
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600">
                                Dédiée à garantir que chaque client vive une
                ...
                >
                    ...
                    <p class="mx-auto mb-8 max-w-2xl text-gray-300">
                        Découvrez dès aujourd’hui l’expérience Afo Rent Car.
