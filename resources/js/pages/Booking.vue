            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <nav class="mb-6 flex items-center space-x-2 text-sm text-gray-500">
                        <a href="/fleet"
                            class="font-medium transition-colors duration-200 hover:text-orange-500">Flotte</a>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-gray-600">
                                Complétez votre réservation en quelques étapes seulement
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid gap-8 lg:grid-cols-3">
                    ...
                    <div class="space-y-8 lg:col-span-2">
                        ...
                        <div class="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-lg">
                            <div class="relative h-72 bg-gradient-to-br from-gray-100 to-gray-200 sm:h-96">
                                <img :src="images[0]?.url" alt="image de la voiture"
                                ...
                                <div class="mb-6 flex items-start justify-between">
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-6 text-sm text-gray-500">
                                            <span class="flex items-center rounded-full bg-gray-100 px-3 py-1">
                                    ...
                                    <div class="text-right">
                                        <div
                                            ...
                                            <span class="block text-sm text-orange-100">
                                                par jour
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <form class="space-y-8">
                                ...
                                <div class="space-y-4">
                                    <h4 class="flex items-center text-lg font-semibold text-gray-900">
                                        <svg class="mr-2 h-5 w-5 text-orange-500" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z">
                                            </path>
                                    ...
                                    <div class="grid gap-6 md:grid-cols-2">
                                        <div class="space-y-2">
                                            ...
                                            <input v-model="form.start_date" type="date" :min="$page.props.minDate"
                                                :max="$page.props.maxDate" required
                                            ...
                                            <span v-if="form.errors.start_date"
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <span v-if="form.errors.end_date" class="text-sm font-medium text-red-500">
                                                {{ form.errors.end_date }}
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid gap-6 md:grid-cols-2">
                                        <div class="space-y-2">
                                            ...
                                            <select v-model="form.pickup_location" required
                                                ...
                                                <option v-for="location in commonLocations" :key="location"
                                                    :value="location">
                                                    {{ location }}
                                                </option>
                                            </select>

                                            <span v-if="form.errors.pickup_location"
                                                class="text-sm font-medium text-red-500">
                                                {{ form.errors.pickup_location }}
                                            </span>
                                        </div>
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <select v-model="form.return_location" required
                                                class="w-full rounded-xl border-2 border-gray-200 bg-white px-4 py-4 text-lg transition-all duration-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-500"
                                                :class="{
                                                    'border-red-500 focus:border-red-500 focus:ring-red-500':
                                            ...
                                            <span v-if="form.errors.return_location"
                                                class="text-sm font-medium text-red-500">
                                                {{ form.errors.return_location }}
                                            </span>
                                        </div>
                    ...
                    <div class="lg:col-span-1">
                        <div class="sticky top-4 rounded-2xl border border-gray-100 bg-white p-8 shadow-lg">
                            ...
                            <button @click="submitBooking" :disabled="!canSubmit || form.processing" :class="{
                                ...
                                <span v-if="form.processing" class="flex items-center justify-center">
                                    <svg class="mr-3 -ml-1 h-6 w-6 animate-spin text-white" fill="none"
                                        viewBox="0 0 24 24">
                                ...
                                <span v-else-if="!$page.props.auth.user" class="flex items-center justify-center">
                                ...
                                <span v-else class="flex items-center justify-center">
                                    <svg class="mr-2 h-5 w-5 fill-white" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 640 640">
                                        <path
