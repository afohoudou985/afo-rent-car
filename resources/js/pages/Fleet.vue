            ...
            >
                ...
                >
                    ...
                    <span class="text-lg font-medium text-gray-700">
                        Chargement des véhicules premium...
                    </span>
                </div>
            </div>
            ...
            <form @submit="handleSearch" class="space-y-3">
                <div class="relative">
                    <input
                        v-model="searchQuery"
                        type="text"
                        placeholder="Rechercher par marque, modèle ou caractéristiques..."
        ...
        <div class="border-t border-gray-200 pt-4">
            <div class="space-y-3">
                ...
                <div>
                    <label
                        class="mb-2 block text-sm font-medium text-gray-700"
                        >Fourchette de prix par jour</label
                    >
...
<div class="lg:w-3/4">
    ...
    >
        ...
        >
            <div>
                ...
                >
                    {{ cars.total }} Véhicules Premium Disponibles
                </h2>
    ...
    >
        ...
        >
            Nous n’avons trouvé aucun véhicule correspondant à vos
            critères. Essayez de modifier vos filtres ou vos termes
            de recherche pour découvrir plus d’options.
        </p>
        <button
            @click="clearFilters"
