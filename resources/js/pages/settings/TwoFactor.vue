        ...
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall
                    ...
                    description="Gérez les paramètres de l’authentification à deux facteurs"
                />
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        ...
                        connexion. Ce code peut être obtenu via une application
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        ...
                        PIN sécurisé et aléatoire vous sera demandé lors de la
                        connexion. Vous pouvez l’obtenir depuis une application
                        compatible TOTP sur votre téléphone.
                    </p>
