...
<template>
            ...
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div
                        ...
                        :style="{ backgroundColor: carsState.totalCars.color }"
                    >
                        <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="p-5">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div
                        class="flex h-8 w-8 items-center justify-center rounded-md"
                        :style="{ backgroundColor: carsState.availableCars.color }"
                    >
                        <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M5 13l4 4L19 7">
        ...
        <div class="p-5">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div
                        class="flex h-8 w-8 items-center justify-center rounded-md"
                        :style="{ backgroundColor: carsState.rentedCars.color }"
                    >
                        <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="p-5">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div
                        class="flex h-8 w-8 items-center justify-center rounded-md"
                        :style="{ backgroundColor: carsState.unavailableCars.color }"
                    >
                        <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="p-6">
        <div class="mb-4 flex items-center justify-between">
            <h3 class="text-lg font-medium text-gray-900">
                Performances des 10 meilleures voitures
            </h3>
            <div class="text-sm text-gray-500">
                    ...
                    <tr>
                        ...
                        >
                            <div class="flex items-center space-x-1">
                                ...
                                <svg
                                    ...
                                    class="h-4 w-4"
                                    :class="sortDirection === 'asc' ? 'rotate-180 transform' : ''"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                        ...
                        >
                            <div class="flex items-center space-x-1">
                                ...
                                <svg
                                    v-if="sortField === 'total_reservations'"
                                    class="h-4 w-4"
                                    :class="sortDirection === 'asc' ? 'rotate-180 transform' : ''"
                                    fill="none"
                                    stroke="currentColor"
                        ...
                        >
                            <div class="flex items-center space-x-1">
                                ...
                                <svg
                                    v-if="sortField === 'utilization_rate'"
                                    class="h-4 w-4"
                                    :class="sortDirection === 'asc' ? 'rotate-180 transform' : ''"
                                    fill="none"
                                    stroke="currentColor"
                        ...
                        <th
                            scope="col"
                            class="cursor-pointer px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase hover:bg-gray-100"
                            @click="sortTable('average_per_reservation')"
                        >
                            <div class="flex items-center space-x-1">
                                <span>Moyenne par réservation</span>
                                <svg
                                    v-if="sortField === 'average_per_reservation'"
                                    class="h-4 w-4"
                                    :class="sortDirection === 'asc' ? 'rotate-180 transform' : ''"
                                    fill="none"
                                    stroke="currentColor"
