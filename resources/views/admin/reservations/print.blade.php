...
<head>
    ...
    <title>Réservation {{ $reservation->reservation_number }}</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <div class="title">Réservation {{ $reservation->reservation_number }}</div>
            @php
        ...
        <div class="section">
            ...
            <div class="section-body">
                <div class="row"><span class="label">Nom</span><span class="value">{{ $reservation->user->name ?? '—' }}</span></div>
        ...
        <div class="section">
            ...
            <div class="section-body">
                <div class="row"><span class="label">Voiture</span><span class="value">@if($reservation->car) {{ $reservation->car->year }} {{ $reservation->car->make }} {{ $reservation->car->model }} @else — @endif</span></div>
                <div class="row"><span class="label">Plaque</span><span class="value">{{ $reservation->car->license_plate ?? '—' }}</span></div>
            </div>
        </div>

        <div class="section">
            <div class="section-header">Détails de la réservation</div>
            <div class="section-body grid">
                ...
                <div>
                    ...
                    <div class="value">{{ $reservation->total_days }} jours</div>
                </div>
                <div>
                    <div class="label">Lieu de prise en charge</div>
        ...
        <div class="section">
            ...
            <div class="section-body">
                @if($reservation->payments->count() === 0)
                    <div class="label">Aucun paiement enregistré.</div>
                @else
                    <table style="width:100%; border-collapse: collapse;">
                        <thead>
                            <tr>
                                <th style="text-align:left; border-bottom: 1px solid #E5E7EB; padding: 6px 4px;">#</th>
                                <th style="text-align:left; border-bottom: 1px solid #E5E7EB; padding: 6px 4px;">Montant</th>
                                <th style="text-align:left; border-bottom: 1px solid #E5E7EB; padding: 6px 4px;">Méthode</th>
                                <th style="text-align:left; border-bottom: 1px solid #E5E7EB; padding: 6px 4px;">Statut</th>
                                <th style="text-align:left; border-bottom: 1px solid #E5E7EB; padding: 6px 4px;">Traitement</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="section">
            <div class="section-header">Totaux</div>
            <div class="section-body">
                <div class="row"><span class="label">Tarif journalier</span><span class="value">{{ $currency }}{{ number_format((float)$reservation->daily_rate, 2) }}</span></div>
                <div class="row"><span class="label">Sous-total</span><span class="value">{{ $currency }}{{ number_format((float)$reservation->subtotal, 2) }}</span></div>
                <div class="row"><span class="label">Taxe</span><span class="value">{{ $currency }}{{ number_format((float)$reservation->tax_amount, 2) }}</span></div>
                <div class="row"><span class="label">Réduction</span><span class="value">-{{ $currency }}{{ number_format((float)$reservation->discount_amount, 2) }}</span></div>
