...
class ReservationsPaymentsSeeder extends Seeder
{
    ...
    private function getReservationData(): array
    {
        ...
        return [
            // 1. Réservation terminée avec paiement réussi
            [
                ...
                'pickup_time' => '10:00',
                'return_time' => '17:00',
                'pickup_location' => 'Terminal Aéroport 1',
                'return_location' => 'Terminal Aéroport 1',
                'notes' => 'Le client était très satisfait du service.',
            ...
            // 2. Réservation active avec paiement complété
            [
                'start_date' => $now->copy()->subDays(2),
                'end_date' => $now->copy()->addDays(3),
                'status' => ReservationStatus::ACTIVE,
                'pickup_location' => 'Bureau Centre-ville',
                'return_location' => 'Bureau Centre-ville',
                'notes' => 'Le client a demandé un système de navigation GPS.',
            ...
            // 3. Réservation future confirmée
            [
                'start_date' => $now->copy()->addDays(7),
                'end_date' => $now->copy()->addDays(10),
                'status' => ReservationStatus::CONFIRMED,
                'pickup_location' => 'Prise en charge Hôtel',
                'return_location' => 'Terminal Aéroport 2',
            ...
            // 4. Réservation le jour même #1 - Matin
            [
                'start_date' => $now->copy(),
                'end_date' => $now->copy(),
                'status' => ReservationStatus::ACTIVE,
                'pickup_time' => '08:00',
                'return_time' => '12:00',
                'pickup_location' => 'Bureau principal',
                'return_location' => 'Bureau principal',
                'notes' => 'Location le jour même (matin).',
            ...
            // 5. Réservation le jour même #2 - Après-midi
            [
                'start_date' => $now->copy(),
                'end_date' => $now->copy(),
                'status' => ReservationStatus::CONFIRMED,
                ...
                'pickup_location' => 'Bureau principal',
                'return_location' => 'Bureau principal',
                'notes' => 'Location le jour même (après-midi).',
            ...
            // 6. Réservation le jour même #3 - Soir
            [
                'start_date' => $now->copy(),
                'end_date' => $now->copy(),
                'status' => ReservationStatus::CONFIRMED,
                ...
                'pickup_location' => 'Bureau Centre-ville',
                'return_location' => 'Bureau Centre-ville',
                'notes' => 'Location le jour même (soir).',
            ...
            // 7. Réservation en attente avec paiement en attente
            [
            ...
            // 8. Réservation annulée avec remboursement
            [
                'start_date' => $now->copy()->addDays(20),
                'end_date' => $now->copy()->addDays(25),
                'status' => ReservationStatus::CANCELLED,
                'cancellation_reason' => 'Le client a changé ses plans de voyage en raison d’une urgence.',
            ...
            // 9. Réservation non honorée
            [
                'start_date' => $now->copy()->subDays(5),
                'end_date' => $now->copy()->subDays(2),
                'status' => ReservationStatus::NO_SHOW,
                'notes' => 'Le client ne s’est pas présenté pour la prise en charge.',
            ...
            [
                ...
                'status' => ReservationStatus::PENDING,
                'notes' => 'Paiement échoué, le client doit réessayer.',
                ...
                'payment_scenarios' => [
                    [
                        ...
                        'method' => PaymentMethod::CREDIT_CARD,
                        'gateway_response' => 'Fonds insuffisants',
                    ],
                    [
                        'status' => PaymentStatus::PENDING,
                        'method' => PaymentMethod::PAYPAL,
            ...
            // 11. Remboursement partiel
            [
                'start_date' => $now->copy()->subDays(12),
                'end_date' => $now->copy()->subDays(8),
                'status' => ReservationStatus::COMPLETED,
                'notes' => 'Véhicule avec un léger problème, remboursement partiel effectué.',
            ...
            // 12. Location longue durée
            [
                'start_date' => $now->copy()->subDays(45),
                'end_date' => $now->copy()->subDays(15),
                'status' => ReservationStatus::COMPLETED,
                'pickup_location' => 'Bureau d’entreprise',
                'return_location' => 'Bureau d’entreprise',
                'notes' => 'Location professionnelle de 30 jours. Client excellent.',
            ...
            [
                ...
                'pickup_time' => '08:00',
                'return_time' => '20:00',
                'pickup_location' => 'Centre-ville',
                'return_location' => 'Centre-ville',
                'notes' => 'Location pour escapade du week-end.',
